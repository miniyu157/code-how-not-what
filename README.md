...
- [ ] **完成 chnw CLI 工具，上传 npm 包**  
    ...
    **\*** *就像 Sillytavern 的预设功能一样，方便使用开关定义文风……*
- [ ] 不知是否应该创建独立的社区仓库，可选为 CLI 工具服务（?）
- [ ] （待补充计划……）
...
> 如果你在日常开发中有更多精妙的、非业务相关的 AI 认知约束沉淀，非常欢迎提交 [Pull Request](https://github.com/miniyu157/code-how-not-what/pulls) 共同完善！
